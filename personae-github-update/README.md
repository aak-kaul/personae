...
> The included `.python-version` file pins Python to 3.12 so the prebuilt
> scientific-package wheels install cleanly. Without it, Render may default to a
> newer Python that lacks pandas wheels and the build fails with
